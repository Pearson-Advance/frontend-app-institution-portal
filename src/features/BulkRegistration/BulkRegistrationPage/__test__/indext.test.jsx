...
const selectFileAndSubmit = (file) => {
  selectFile(file);
...
describe('Loading', () => {
  test('Should show the loading screen immediately after clicking Upload & Process', () => {
    renderComponent();
    selectFileAndSubmit(makeFile('students.csv'));
  ...
  test('Should not render the loading screen after a fatal API error', async () => {
    renderComponent();
    selectFileAndSubmit(makeFile('fatal.csv'));
...
describe('Success', () => {
  ...
  test('Should show the partial success summary with correct stat labels when some students already existed', async () => {
    renderComponent();
    selectFileAndSubmit(makeFile('partial.csv'));
...
describe('Error', () => {
  test('Should show the error state with the failed rows description when the CSV contains invalid rows', async () => {
    renderComponent();
    selectFileAndSubmit(makeFile('error.csv'));
  ...
  test('Should render Validation failed and Processing failed status badges in the error table', async () => {
    renderComponent();
    selectFileAndSubmit(makeFile('error.csv'));
  ...
  test('Should return to the idle upload form after clicking Upload Another on the error rows screen', async () => {
    renderComponent();
    selectFileAndSubmit(makeFile('error.csv'));
  ...
  test('Should show the fatal error screen with the generic error message when the API returns a 500', async () => {
    renderComponent();
    selectFileAndSubmit(makeFile('fatal.csv'));
  ...
  test('Should return to the idle upload form after clicking Try again on the fatal error screen', async () => {
    renderComponent();
    selectFileAndSubmit(makeFile('fatal.csv'));
